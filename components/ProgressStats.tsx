        ...
        <LinearGradient colors={colors.gradients.surface} style={settingsStyles.section}>
            ...
            >
                ...
                <View style={ {flexDirection: "row", alignItems: "center", gap: 10} }>
                    ...
                    <Text style={[settingsStyles.statLabel, {fontSize: 18}]}> Total todos</Text>
                </View>
            </LinearGradient>
            ...
            style={[settingsStyles.statCard, { borderLeftColor: colors.success}]}>
                ...
                <View style={{flexDirection: "row", alignItems: "center", gap: 10 }}>
                    ...
                    <Text style={[settingsStyles.statLabel, {fontSize: 18}]}>Completed</Text>
                </View>
            </LinearGradient>
            ...
            style={[settingsStyles.statCard, { borderLeftColor: colors.warning}]}>
                ...
                <View style={{flexDirection: "row", alignItems: "center", gap: 10 }}>
                    ...
                    <Text style={[settingsStyles.statLabel, {fontSize: 18}]}>Pending</Text>
                </View>
            </LinearGradient>
            </View>
        </LinearGradient>
